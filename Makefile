...
run: compile
	java -classpath ./classes:$(CLASSPATH) Main ./tests/test1.sysy ./tests/test1.asm
...
test: compile
	...
	nohup java -classpath ./classes:$(CLASSPATH) Main ./tests/test1.sysy ./tests/test1.riscv &
...
mySubmit: clean compile submit

runll:
	lli /home/cz/schoolwork/compiler/Lab/tests/test1.ll; echo $$?

getIr:
	clang -S -emit-llvm -fno-discard-value-names /home/cz/schoolwork/compiler/Lab/tests/main.c -o /home/cz/schoolwork/compiler/Lab/tests/main.ll -O0 -g0
